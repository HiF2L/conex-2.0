...
def register_handlers(router: Router, memory_engine: MemoryEngine, llm_client: LLMClient, extractor_service: ExtractorService):
    ...
    async def handle_voice_message(message: Message):
        ...
        response = llm_client.generate_coaching_response(system_prompt, transcription, chat_history=chat_history, memory_engine=memory_engine, trace=trace)
    ...
    async def handle_text_message(message: Message):
        ...
        response = llm_client.generate_coaching_response(system_prompt, user_text, chat_history=chat_history, memory_engine=memory_engine, trace=trace)
