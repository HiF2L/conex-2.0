...
class MemoryEngine:
    ...
    def assemble_prompt(self, user_input: str) -> Tuple[str, MemoryTrace]:
        ...
        prompt_lines.extend([
            ...
            "7. HOLISTIC ANALYSIS & META-QUERY PROTOCOL: Evaluate the intent of every user request. Whenever the user seeks high-level synthesis, identity analysis, global project portfolio overviews, or personal evaluation: (a) Operational short-term context (daily tasks, maintenance pings, transient energy) is strictly INSUFFICIENT for an authentic response. (b) BEFORE generating the final response, executing search_memory for relevant entity namespaces, core identity, or long-term goals is MANDATORY. (c) NEVER summarize or judge the user's core personality based solely on temporary daily chores or short-term maintenance tasks."
        ])
