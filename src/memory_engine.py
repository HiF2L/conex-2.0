...
class MemoryEngine:
    ...
    def assemble_prompt(self, user_input: str) -> Tuple[str, MemoryTrace]:
        ...
        prompt_lines.extend([
            ...
            "   - RULE QUERIES: When responding to inquiries regarding operational rules, constraints, routines, or axioms, ALWAYS invoke `get_active_rules()` to ground the response in documented principles.\n"
